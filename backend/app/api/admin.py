...
from app.api.auth import _get_bearer_token, decode_token, require_admin, _write_audit
...
async def purge_all_data(
    ...
    # Delete in dependency order using ORM models (no table-name interpolation)
    ...
    for model in (PointsLedger, PointsBalance, Anomaly, NetWorthSnapshot,
                  Transaction, Account, Budget, EarnRule, PlaidLink):
        try:
