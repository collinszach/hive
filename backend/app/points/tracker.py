...
EARN_RULES: list[EarnRuleData] = [
    ...
    # Chase Southwest Plus — SW Flights MUST be 3x, not generic Travel 2x
    ...
    EarnRuleData("wf_autograph", "Travel", None, 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Food & Drink", "Restaurant", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Food & Drink", "Fast Food", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Transportation", "Gas", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Transportation", "EV Charging", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Transportation", "Transit", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Transportation", "Parking", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Transportation", "Tolls", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Entertainment", None, 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", "Utilities", "Phone", 3.0, "WF Rewards"),
    EarnRuleData("wf_autograph", None, None, 1.0, "WF Rewards"),

    # Capital One Venture X — 2x everywhere is the base
