  ...
  const policies: PolicySection[] = [
    {
      ...
      content: (
        <div className="space-y-3 text-[13px] text-ink-secondary">
          <p>Hive implements RBAC with two roles:</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-[13px] text-ink-secondary">
          <p>Hive supports TOTP-based two-factor authentication (RFC 6238). Compatible with Google Authenticator, Authy, 1Password, and any TOTP app.</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-3 text-[13px] text-ink-secondary">
          <p><strong className="text-ink-primary">Scope:</strong> Hive is a single-user, self-hosted personal application. There are no employees or organizational accounts.</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-[13px] text-ink-secondary">
          <p className="font-semibold text-ink-primary">Information Security Policy — Hive</p>
          <div className="space-y-4">
            <div>
              <p className="font-medium text-ink-primary mb-1">Purpose</p>
              <p>To protect the confidentiality, integrity, and availability of personal financial data processed by Hive, including data obtained through Plaid API integrations.</p>
            </div>
            <div>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4 text-[13px] text-ink-secondary">
          <p className="font-semibold text-ink-primary">Access Control Policy — Hive</p>
    ...
    <div className="space-y-5 max-w-3xl animate-fade-in">
      <div>
        ...
        <p className="text-[13px] text-ink-tertiary">
          Plaid attestation requirements and security policies for Hive
        </p>
      </div>
